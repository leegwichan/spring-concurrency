package concurrency.demo.service.v1;
...
@ActiveProfiles("v1")
class CustomizeTableServiceV1Test extends ServiceTest {

    @Autowired
    private CustomizeTableService customizeService;

    @Test
    void updateTableTest_whenRunAtSameTime_occurDeadlock() throws InterruptedException {
        // Given (Setup)
